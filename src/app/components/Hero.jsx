...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_50%,rgba(255,255,255,0.1)_0%,transparent_50%),radial-gradient(circle_at_80%_80%,rgba(255,255,255,0.1)_0%,transparent_50%)] pointer-events-none" />
      
      {/* Animated Wave */}
      <div className="absolute inset-0 opacity-30">
        <svg className="absolute bottom-0 w-full h-24 animate-wave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        ...
        <div className="text-center max-w-[900px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <button
              ...
              className="px-10 py-4 rounded-full font-semibold text-white bg-gradient-to-br from-[#4FA39A] to-[#5AB5B8] shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all text-lg"
            >
              Explore Plans
            </button>
            <button
